...
<section class="report">
        ...
        foreach($curReport['elements']->values as $key => $element) {
            ...
            $elementHtml .= '
            <li>
                <a href="#'.$pageCount.'">'.($key + 1).'. '.$element['title'].'</a>
        ...
        foreach($curReport['elements']->values as $key => $element) {
            ...
            foreach($element as $elementKey => $elementValue) {
                if($elementKey !== 'title') {
                    ...
                    $elements .= '
                        <page>
<section '.$style.' id="'.$elementPageCount.'" class="before">
                    ...
                    foreach($elementValue['elements'] as $elementBlock) {
                        switch($elementBlock['type']) {
                            ...
                            case 'text':
                                $elements .= '<div class="textArea">'.$elementBlock['value'][0].'</div>';
                                break;
...
<section class="contacts">
            ...
            <div class="user-block">
                ...
                <div class="user">
                    <div class="user__image">
                        <img src="http://reports.umax.agency'.$curReport['report']->photo.'" />
                    </div>
        ...
        $html .= '
            <script src="https://raw.githack.com/eKoopmans/html2pdf/master/dist/html2pdf.bundle.js">asd</script>
            </body>
        </html>
        ';
