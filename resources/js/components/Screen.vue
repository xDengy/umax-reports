  ...
  <div class="screen" :id="'screen-'+screenNumber">
    <div class="screen__top">
      ...
      <div class="screen__top-buttons">
        <div @click="screenDown($event.target.parentNode.parentNode.parentNode)" class="screen__top-button">вниз</div>
        ...
        <div @click="screenUp($event.target.parentNode.parentNode.parentNode)" class="screen__top-button">вверх</div>
      </div>
    </div>
    ...
    <div class="screen__wrap">
      ...
      <div class="image__wrapper">
        <input name="file_screen" type="file" id="input__file_screen" class="input input__file"
          @change="setImg($event.target)">
        <label for="input__file_screen" class="input__file-button">
